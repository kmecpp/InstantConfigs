package com.kmecpp.effortlessconfigs.util;
...
public class IOUtil {
	...
	public static String[] readLines(URL url) throws IOException {
		return getLines(readString(url));
	}
	 ...
	 * @return an array of lines read from the input stream
	 * @throws IOException
	 *             if an error occurs while reading from the url
	 */
	public static String[] readLines(InputStream inputStream) throws IOException {
		return getLines(readString(inputStream));
	}
	...
	public static String[] readLines(File file) throws IOException {
		return getLines(readString(file));
	}
